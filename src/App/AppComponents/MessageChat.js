...
export default class MessageChat {
    ...
    buildMessageAlt(){
        ...
        if(this.platform == "s1live"){
            platformSrc = "http://localhost:3000/static/images/s1icon.png\" style=\"background-color: white; width: 20px; margin-top: 1px; margin-left: 15px; border-radius: 100%;\"";
        }
